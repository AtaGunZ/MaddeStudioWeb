...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="w-full py-20 px-6 md:px-12 border-t border-black/5 dark:border-white/5 bg-madde-white dark:bg-madde-black transition-colors duration-500">
      <div className="max-w-[1920px] mx-auto">
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              <img 
                ...
                alt="Madde Studio" 
                className="w-full h-full dark:invert-0 invert opacity-70"
              />
            </button>
          </div>
        ...
        <div className="flex justify-between items-end pt-8 border-t border-black/5 dark:border-white/5">
